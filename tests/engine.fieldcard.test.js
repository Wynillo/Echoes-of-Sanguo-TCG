...
describe('FieldCard', () => {
  ...
  it('reads piercing passive flag', () => {
    const card = { ...baseCard, effect: { trigger:'passive', piercing: true } };
    const fc = new FieldCard(card);
